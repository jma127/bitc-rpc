...
static void config_insert(struct config *config, struct KeyValuePair *e) {
...
static struct KeyValuePair *config_get(const struct config *config,
                                       const char *key) {
...
void config_setint64(struct config *config, int64 val, const char *fmt, ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
void config_setbool(struct config *config, bool s, const char *fmt, ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
bool config_isset(struct config *config, const char *fmt, ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
void config_setstring(struct config *config, const char *str, const char *fmt,
                      ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
static void config_setunknownkv(struct config *config, const char *key,
                                const char *val) {
  struct KeyValuePair *e;
...
static void config_chomp(char *str) {
...
static bool config_parseline(char *line, char **key, char **val) {
  size_t len;
  char *ptr;
  char *k;
  char *v;
...
int64 config_getint64(struct config *config, int64 defaultValue,
                      const char *format, ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
bool config_getbool(struct config *config, bool defaultValue, const char *fmt,
                    ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
char *config_getstring(struct config *config, const char *defaultStr,
                       const char *format, ...) {
  struct KeyValuePair *e;
  char key[1024];
  va_list ap;
...
int config_load(const char *fileName, struct config **confOut) {
...
int config_save(struct config *conf) { return config_write(conf, NULL); }
