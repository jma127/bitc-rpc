...
typedef void(netasync_recv_callback)(struct netasync_socket *socket, void *buf,
...
int netasync_receive(struct netasync_socket *sock, void *buf, size_t bufLen,
                     bool partial, netasync_recv_callback *callback,
                     void *clientData);
