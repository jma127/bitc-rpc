...
static void bitc_test_one_tx(struct btc_tx_desc *desc) {
...
static void bitc_pool_test(void) {
...
static void bitc_crypt_test(void) {
...
static void bitc_hashtable_test(void) {
